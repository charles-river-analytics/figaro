...
```
libraryDependencies += "com.cra.figaro" %%  "figaro" % "2.3.0.0"
```
...
Apache Ivy Projects
```
<dependency org="com.cra.figaro" name="figaro_2.11" rev="2.3.0.0" />
```
...
For instance:
```
scala -cp figaro_2.11-2.3.0.0-fat.jar;figaroexamples_2.11-2.3.0.0.jar com.cra.figaro.example.Burglary
```
