...
```
libraryDependencies += "com.cra.figaro" %%  "figaro" % "2.2.2.0"
```
...
Apache Ivy Projects
```
<dependency org="com.cra.figaro" name="figaro_2.11" rev="2.2.2.0" />
```
...
```
scala -cp figaro_2.11-2.2.2.0-fat.jar;figaroexamples_2.11-2.2.2.0.jar <example_class>
```

For instance:
```
scala -cp figaro_2.11-2.2.2.0-fat.jar;figaroexamples_2.11-2.2.2.0.jar com.cra.figaro.example.Burglary
```
