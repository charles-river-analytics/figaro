...
\begin{flushleft}
    ...
    \newline val bp2 = BeliefPropagation(10, u)(universe)
    \newline bp2.start
    \newline bp2.stop
    \newline val withCondition = bp2.computeEvidence()
    \newline bp2.kill()
    \newline val e1 = withCondition/withoutCondition
  }
\end{flushleft}
...
The result of each computation is approximately .333. \texttt{println(e1 + " " + e2 + " " + e3)} yields 
