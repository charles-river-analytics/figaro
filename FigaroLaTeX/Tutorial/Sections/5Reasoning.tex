...
Continuous elements are handled in BP the same was as in variable elimination (abstractions or sampled). However, Figaro also provides an experimental implementation of particle belief propagation that is designed to reason with continuous elements by repeated sampling of continuous elements (instead of just once using normal BP). This algorithm can be found in \texttt{com.cra.figaro.experimental.particlebp}.
